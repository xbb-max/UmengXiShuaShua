...
//        int type = 0;
        ...
        Element root = new Element(Const.DOCMENT);
        nodeStack.push(root);
        Element node = null;
        ...
        while (index < lenght)
        {
            ...
            if (aChar == '<')
            {
                ...
                if (aChar == '/')
                {
                    ...
                    if (tag.equals(root.getTag()))
                    {
                        if (root.children != null)
                        {
                            ...
                            {
                                if (root.getText() != null && !root.getText().equals(Const.STRING))
                                {
                                    node = new Element(Const.STRING);
                ...
                else if (aChar == '!')
                {
                    ...
                    {
                        int tmp = text.indexOf(Const.COMMET_END, index);
...
//                    System.out.println(stmp);
                    ...
                    node.setTag(tag);
//                    Util.debug("parent:"+root.getTag()+"---------tag:"+tag);
//                    Util.debug("src:"+root.getAttr("src"));
    ...
    {
        Element node = new Element(Const.STRING);
        int index = 0;
...
//        s = Util.replaceAll(s, Const.T13, Const.T13_, false);
    ...
    public static String convert(String s)
    {
        do
        {
            ...
            String str = Const.T2 + s.substring(k1 + 3, k2);
            str = Util.unicodeToString(str);
